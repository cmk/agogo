...
This is the Claude Code implementation of the
`plan_finalized -> local_reviewed` FSM transition. Codex and shell users
run `scripts/local_review.sh` for the same transition.
