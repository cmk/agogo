...
enum LinkSub {
    ...
    Probe {
        ...
        #[bpaf(long, argument::<String>("BPM"), parse(parse_bpm_to_tempo), fallback(agogo_core::conn::tempo::Tempo::from_bpm_integer(120)))]
...
fn main() {
    ...
    match cli.command {
        Some(Command::Sync {
            ...
            {
                if sr
                    != <agogo_core::conn::sample::S048 as agogo_core::conn::sample::SampleRate>::HZ
                {
                    eprintln!(
