...
//!   argv parsers, FFI parity helpers, and the PI-controller
//!   f64 ↔ fxp seam. All sites that knowingly touch `f64` route
//!   through here so the rest of the workspace stays float-free.
//! - [`rate`] — `SampleRate` ladder and the `FD12Rxxx` Conns
